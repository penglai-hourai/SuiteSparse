...
/* global GPU parameters*/
  ...
  #define CHOLMOD_MAX_NUM_GPU_PARALLEL 16
  #define CHOLMOD_MAX_NUM_SUBTREE_PARALLEL 16
  ...
  #define CHOLMOD_DEVICE_LX_BUFFERS 2 // must be no less than IBUFF_LOOPSIZE
...
typedef struct cholmod_common_struct
{
	...
	* and Xwork).  Added for CHOLMOD v1.1 */
    ...
    CHOLMOD_CUDASTREAM    gpuStream[CHOLMOD_MAX_NUM_GPUS * CHOLMOD_MAX_NUM_SUBTREE_PARALLEL][CHOLMOD_DEVICE_STREAMS+2];
