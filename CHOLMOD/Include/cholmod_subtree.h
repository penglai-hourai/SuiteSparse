...
#define IBUFF_LOOPSIZE 2 // must not be greater than either CHOLMOD_HOST_SUPERNODE_BUFFERS or CHOLMOD_DEVICE_LX_BUFFERS
#define MAP_CACHESIZE 2

#define UPDATE_MAX_BATCH_COUNT (1024)
#define UPDATE_BATCH_DIMENSION_M (64)
#define UPDATE_BATCH_DIMENSION_N (64)
#define UPDATE_BATCH_DIMENSION_K (64)
#define UPDATE_BATCH_SIZE_A (UPDATE_BATCH_DIMENSION_M * UPDATE_BATCH_DIMENSION_K)
#define UPDATE_BATCH_SIZE_C (UPDATE_BATCH_DIMENSION_M * UPDATE_BATCH_DIMENSION_N)
